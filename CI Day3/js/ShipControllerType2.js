class ShipControllerType2 {
  ...
  update(){
    ...
    if (Nakama.keyboard.isDown(this.configs.left)){
      ...
      this.sprite.frameName = "Spaceship2Left-Player.png";
    }
    else if (Nakama.keyboard.isDown(this.configs.right)){
      this.sprite.body.velocity.x = Nakama.configs.shipSpeed;
      this.sprite.frameName = "Spaceship2Right-Player.png";
    }
    else {
      this.sprite.body.velocity.x = 0;
      this.sprite.frameName = "Spaceship2-Player.png";
    }
